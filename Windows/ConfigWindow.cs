    ...
    public override void Draw()
    {
        ...
        if (ImGui.BeginTable("##types", 3, ImGuiTableFlags.SizingFixedFit))
        {
            ...
            DrawTypeRow("Pop-up help",
                ...
                "Also controls the name label that appears when hovering over hotbar slots\n" +
                "and items. To see names without the full tooltip, leave this shown and\n" +
                "only enable the action and item toggles above.");
